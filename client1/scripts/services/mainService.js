(function () {
    ...
    function MainService($http, $state, $rootScope, $timeout, ConfigService){
        ...
        function Login(params) {
            return $http.post(ConfigService.BaseURI() + '/web/api/abCheck', params).then(handleSuccess, handleRemoteError);
        }
        ...
        function Register(params) {
            return $http.post(ConfigService.BaseURI() + '/web/api/abRegister', params).then(handleSuccess, handleRemoteError);
        }
